...
const ModelsPageContent = () => {
    const initialModels = use(fetchModels());
...
const ModelsPageFallback = () => (
    <div className="space-y-8">
        <div className="flex justify-between items-center mb-8">
            <div className="h-8 w-48 rounded bg-gray-800 animate-pulse" />
            <div className="h-10 w-32 rounded bg-gray-800 animate-pulse" />
        </div>
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 p-6 rounded-lg shadow-lg mb-8 border border-gray-700/50">
            <div className="h-6 w-40 rounded bg-gray-800 animate-pulse mb-4" />
            <div className="h-10 w-full rounded bg-gray-800 animate-pulse" />
        </div>
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 p-6 rounded-lg shadow-lg border border-gray-700/50">
            <div className="h-6 w-40 rounded bg-gray-800 animate-pulse mb-4" />
